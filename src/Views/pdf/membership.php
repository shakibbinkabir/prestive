  ...
  <div class="section">
    <table>
      <tbody>
        ...
        <tr><th>Mobile</th><td><?= htmlspecialchars($app['mobile'] ?? '') ?></td></tr>
        <tr><th>Gender</th><td><?= htmlspecialchars($app['gender'] ?? '') ?></td></tr>
        <tr><th>Date of Birth</th><td><?= htmlspecialchars($app['dob'] ?? '') ?></td></tr>
        <tr><th>Membership Type</th><td><?= htmlspecialchars($app['membership_type'] ?? '') ?></td></tr>
        <tr><th>Organization</th><td><?= htmlspecialchars($app['organization'] ?? '') ?></td></tr>
